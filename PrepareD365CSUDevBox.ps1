...
invoke-choco install -y python visualstudio2022-workload-manageddesktopbuildtools visualstudio2022-workload-universalbuildtools visualstudio2022-workload-webbuildtools --force
